...
if(isset($_GET['delid']))
{
    ...
    // Get image name before deleting database record
    $sql = "SELECT Image FROM tblstudent WHERE ID=:rid";
    ...
    {
        $imagePath = "/var/www/html/php/uploads/" . $result->Image;
    ...
    echo "<script>alert('Data and image deleted');</script>";
